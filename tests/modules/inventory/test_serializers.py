...
from src.modules.inventory.serializers import (CategorySerializer,
                                               ProductSerializer,
...
class TestStockLevelSerializer:
    ...
    def setup_stock(self, db):
        ...
        product = Product.objects.create(
            sku="STK001", name="Stock Item", category=category, unit_price=10.00
        )
...
class TestStockAdjustmentSerializer:
    ...
    def setup_data(self, db):
        ...
        category = Category.objects.create(name="Test Cat")
        product = Product.objects.create(
            sku="ADJ001", name="Adjust Item", category=category, unit_price=20.00
        )
        return {
            "product": product,
            "warehouse": warehouse,
